...
export class InvoiceService {
  ...
  getByPersonId(id : number, pageable: Pageable){
    ...
    return this.httpClient.get('http://localhost:8080/invoice/get/person/'+id,options);
  }

  /** This method deletes an invoice */
  delete(id : number){    
    return this.httpClient.delete('http://localhost:8080/invoice/delete/'+id);
  }

  /** This method gets an invoice by id */
  get(id : number){    
    return this.httpClient.get('http://localhost:8080/invoice/get/'+id);
  }

  /** This method saves an invoice */
  save(invoice: Invoice){
     return this.httpClient.post('http://localhost:8080/invoice/save',invoice,

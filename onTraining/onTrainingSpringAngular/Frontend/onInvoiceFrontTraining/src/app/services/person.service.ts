...
export class PersonService {
  ...
  getAll(pageable: Pageable){
    ...
    return this.http.get('http://localhost:8080/api/person/get/all',options);
  }


  /** This method returns a specific person */
  get(id :number){
    return this.http.get('http://localhost:8080/api/person/get/'+id);
  }

  /** This method saves a person */
  save(person :Person){
    return this.http.post('http://localhost:8080/api/person/save',person,
  ...
  delete(id :number){
    return this.http.delete('http://localhost:8080/api/person/delete/'+id);
  }
